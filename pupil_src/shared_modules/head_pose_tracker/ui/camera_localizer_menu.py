...
class CameraLocalizerMenu(plugin_ui.StorageMenu):
    ...
    def _render_custom_ui(self, camera_localizer, menu):
        menu.extend(
            [
                self._create_range_selector(camera_localizer),
    ...
    def _create_range_selector(self, camera_localizer):
        ...
        return ui.Button(
            ...
            function=lambda: self._on_set_index_range_from_trim_marks(camera_localizer),
        )
    ...
    def _create_calculate_button(self, camera_localizer):
        return ui.Button(
            ...
            function=lambda: self._on_click_calculate(camera_localizer),
        )
    ...
    def _on_set_index_range_from_trim_marks(self, camera_localizer):
        self._camera_localizer_controller.set_range_from_current_trim_marks(
            camera_localizer
        )
        self.render()

    def _on_click_calculate(self, camera_localizer):
